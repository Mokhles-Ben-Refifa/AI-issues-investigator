...
import sqlite3
import hashlib
from agents.RAG.database.rag_database import initialize_rag_chain, query_rag_chain
...
class DatabaseAgent(Agent):
    def __init__(self, queue):
        ...
        self.rag_chain = initialize_rag_chain("agents/RAG/database/db_doc.md")
    ...
    def generate_recommendation(self, root_cause, explanation):
        ...
        rag_info = self.rag_chain.run(f"How to resolve this database issue: {root_cause}")
